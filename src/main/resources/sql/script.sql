...
insert into users values('shreyas','12345','1')
insert into authorities values('shreyas','write')

insert into customer (`email`,`pwd`,`role`) values ('shreyas@gmail.com','shreyas123','admin')
